...
sap.ui.define([
	...
	"com/coil/podium/Manage_Event_Info/test/flpSandbox"
	...
	return Opa5.extend("com.coil.podium.Manage_Event_Info.test.integration.arrangements.FLP", {
		/**
		...
		iRestartTheAppWithTheRememberedItem: function (oOptions) {
			this.waitFor({
				success: function () {
					...
					oOptions.hash = "EventInfoSet/" + encodeURIComponent(sObjectId);
