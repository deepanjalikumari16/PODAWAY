		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Manage Events and Attractions",
									"targetURL": "#ManageEventsandAttractions-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ManageEventsandAttractions-display": {
								"semanticObject": "ManageEventsandAttractions",
								"action": "display",
								"description": "Manage Events &amp; Attractions for admins",
								"title": "Manage Events and Attractions",
								"signature": {
									"parameters": {}
								},
