...
sap.ui.define([
	...
	"com/coil/podium/VisitorJourney/test/flpSandbox"
	...
	return Opa5.extend("com.coil.podium.VisitorJourney.test.integration.arrangements.FLP", {
		/**
		...
		iRestartTheAppWithTheRememberedItem: function (oOptions) {
			this.waitFor({
				success: function () {
					...
					oOptions.hash = "EventAttractionSet/" + encodeURIComponent(sObjectId);
