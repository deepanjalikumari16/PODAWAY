						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#AssignmentList-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"AssignmentList-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Assignment_List.Assignment_List",
									"url": sap.ui.require.toUrl("Assignment_List/Assignment_List")
								}
							}
						}
					}
