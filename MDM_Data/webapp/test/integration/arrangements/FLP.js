...
sap.ui.define([
	...
	"com/coil/podium/MDM_Data/test/flpSandbox"
	...
	return Opa5.extend("com.coil.podium.MDM_Data.test.integration.arrangements.FLP", {
		/**
		...
		iRestartTheAppWithTheRememberedItem: function (oOptions) {
			this.waitFor({
				success: function () {
					...
					oOptions.hash = "MasterServiceTypeSet/" + encodeURIComponent(sObjectId);
