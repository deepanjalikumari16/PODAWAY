...
sap.ui.define([
	...
	"com/coil/podium/Notifications/test/flpSandbox"
	...
	return Opa5.extend("com.coil.podium.Notifications.test.integration.arrangements.FLP", {
		/**
		...
		iRestartTheAppWithTheRememberedItem: function (oOptions) {
			this.waitFor({
				success: function () {
					...
					oOptions.hash = "NotificationSet/" + encodeURIComponent(sObjectId);
