sap.ui.define([
	...
	return BaseController.extend("com.coil.podway.MAAD.controller.Worklist", {
		...
		onMessage: function (oEvent) {
			...
			if (!this.byId("messageDialog")) {
				...
				Fragment.load({
					id: oView.getId(),
					name: "com.coil.podway.MAAD.view.MessageDialog",
					controller: this
		...
		onComment: function (oEvent) {
			...
			if (!this.byId("commentDialog")) {
				...
				Fragment.load({
					id: oView.getId(),
					name: "com.coil.podway.MAAD.view.CommentDialog",
					controller: this
				}).then(function (oDialog) {
					// connect dialog to the root view 
					//of this component (models, lifecycle)
		...
		onPodCategory: function (oEvent) {
			...
			if (!this._oPopover) {
				Fragment.load({
					name: "com.coil.podway.MAAD.view.PODCategoryDialog",
					controller: this
		...
		onSpeciality: function (oEvent) {
			...
			if (!this._oPopover) {
				Fragment.load({
					name: "com.coil.podway.MAAD.view.SpecialityDialog",
					controller: this
				}).then(function (pPopover) {
					this._oPopover = pPopover;
					this.getView().addDependent(this._oPopover);
