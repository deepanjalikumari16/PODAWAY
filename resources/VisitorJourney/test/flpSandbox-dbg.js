		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Manage Curated Journey",
									"targetURL": "#ManageCuratedJourney-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ManageCuratedJourney-display": {
								"semanticObject": "ManageCuratedJourney",
								"action": "display",
								"description": "Manage curated journey for POD visitors",
								"title": "Manage Curated Journey",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.coil.podium.VisitorJourney",
									"url": sap.ui.require.toUrl("com/coil/podium/VisitorJourney")
								}
							}
						}
					}
