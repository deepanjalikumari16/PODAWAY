						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#MasterDataManagement-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"MasterDataManagement-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.coil.podium.MDM_Data",
									"url": sap.ui.require.toUrl("com/coil/podium/MDM_Data")
								}
							}
						}
					}
