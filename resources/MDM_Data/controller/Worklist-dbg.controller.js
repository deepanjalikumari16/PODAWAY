jQuery.sap.require("com.coil.podway.MDM_Data.libs.mapsjs-core");
jQuery.sap.require("com.coil.podway.MDM_Data.libs.mapsjs-service");
jQuery.sap.require("com.coil.podway.MDM_Data.libs.mapsjs-ui");
jQuery.sap.require("com.coil.podway.MDM_Data.libs.mapsjs-mapevents");
...
sap.ui.define([
	...
	return BaseController.extend("com.coil.podway.MDM_Data.controller.Worklist", {
		...
		onViewImage: function (oEvent, sDialogType) {
			...
			if (!that._oDlgAddOption) {
				...
				Fragment.load({
					id: oView.getId(),
					name: "com.coil.podway.MDM_Data.dialog.Images",
					controller: that
		...
		onMap: function () {
			...
			Fragment.load({
				...
				type: "HTML",
				name: "com.coil.podway.MDM_Data.dialog.HEREMaps",
				controller: that
			}).then(function (oDialog) {
				//that._oDlgAddOption = oDialog;
				// connect dialog to the root view of this component (models, lifecycle)
		...
		onEdit: function (oEvent) {
			...
			if (sSelectedKey === "Service") {
				...
				if (!this.byId("detailsDialog")) {
					...
					Fragment.load({
						id: oView.getId(),
						name: "com.coil.podway.MDM_Data.dialog.details",
						controller: this
					}).then(function (oDialog) {
						// connect dialog to the root view of this component (models, lifecycle)
						oView.addDependent(oDialog);
