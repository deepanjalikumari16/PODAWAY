		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Manage Event Info",
									"targetURL": "#ManageEventInfo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ManageEventInfo-display": {
								"semanticObject": "ManageEventInfo",
								"action": "display",
								"description": "Manage event info app for admins",
								"title": "Manage Event Info",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.coil.podium.Manage_Event_Info",
									"url": sap.ui.require.toUrl("com/coil/podium/Manage_Event_Info")
								}
							}
						}
					}
