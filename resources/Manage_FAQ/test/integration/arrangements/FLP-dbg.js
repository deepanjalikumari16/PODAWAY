...
sap.ui.define([
	...
	"com/coil/podium/Manage_FAQ/test/flpSandbox"
	...
	return Opa5.extend("com.coil.podium.Manage_FAQ.test.integration.arrangements.FLP", {
		/**
		...
		iRestartTheAppWithTheRememberedItem: function (oOptions) {
			this.waitFor({
				success: function () {
					...
					oOptions.hash = "FaqSet/" + encodeURIComponent(sObjectId);
