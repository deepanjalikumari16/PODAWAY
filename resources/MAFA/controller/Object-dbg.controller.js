sap.ui.define([
	...
	return BaseController.extend("com.coil.podway.MAFA.controller.Object", {
		...
		*/
		...
		onMap: function () {
			...
			Fragment.load({
				...
				type: "HTML",
				name: "com.coil.podway.MAFA.dialog.HEREMaps",
				controller: that
		...
		loadHERELibs: function () {
			...
			jQuery.sap.require("com.coil.podway.MAFA.libs.mapsjs-core");
			jQuery.sap.require("com.coil.podway.MAFA.libs.mapsjs-service");
			jQuery.sap.require("com.coil.podway.MAFA.libs.mapsjs-ui");
			jQuery.sap.require("com.coil.podway.MAFA.libs.mapsjs-mapevents");
